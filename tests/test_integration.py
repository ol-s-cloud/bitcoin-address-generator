...
from bitcoin_address_generator import generate_qr_code, generate_wallet
...
def test_full_workflow():
    ...
    test_key = (
        "7b0cda14ab09ebeceb460d47b92f959f"
        "02540436c98147a81bd07700ea6a9e6a"
    )
...
def test_qr_code_generation(tmp_path):
    """Generate a shareable QR image for a public Bitcoin address."""
    output = tmp_path / "address.png"
